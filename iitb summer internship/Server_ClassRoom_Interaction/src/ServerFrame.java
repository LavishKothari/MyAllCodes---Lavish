...
public class ServerFrame extends JFrame implements ActionListener,ChangeListener,MouseListener,KeyListener
{
	...
	ServerFrame(String professorName,String departmentName,String subjectName,String topicName) throws IOException
	{
		...
		*/
		...
		tabbedPane.addTab("<html><body leftmargin=15 topmargin=0 marginwidth="+(int)(this.width*0.15)+" marginheight=0><h2>Audio<h2></body></html>",audioPanel);
		tabbedPane.addTab("<html><body leftmargin=15 topmargin=0 marginwidth="+(int)(this.width*0.15)+" marginheight=0><h2>Text</h2></body></html>",textPanel);
